...
export const validator = function () {
    ...
    return {
        ...
        min: function (value: number, errorMessage?: string) {
            minValue = value
        ...
        test: function (value: string | boolean | string[]) {
            ...
            if (typeof value !== 'string') return typeErrorMessage
...
const getValue = (value: string | boolean | string[], type: string) =>
    type === 'multiselect' ? getSelectedOptions() : value
...
type SchemaType = {
    [key: string]: ReturnType<typeof validator>
}
